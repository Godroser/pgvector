#!/usr/bin/env python3
"""Hash Join fit: train 40 / test 10."""
...
def main() -> None:
    ...
    ap.add_argument("--data", default=os.path.join(os.path.dirname(__file__), "data", "hashjoin_samples.jsonl"))
    ap.add_argument("--out", default=os.path.join(os.path.dirname(__file__), "models", "hashjoin_coef.json"))
    ...
    payload = {"operator": "Hash Join", "features": names, "total_samples": len(rows), **ev}
    ppath = os.path.join(os.path.dirname(args.out), "hashjoin_test_predictions.jsonl")
