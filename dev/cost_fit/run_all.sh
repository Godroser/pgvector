...
# python3 06_fit_sort_new.py || echo "skip sort fit (need >=50 sort samples: 40 train + 10 test)"
...
# python3 09_collect_mergejoin_new.py && python3 10_fit_mergejoin_new.py || echo "skip mergejoin fit (no merge plans)"
...
echo "=== Test metrics (160 train / 40 test by default for IVFFlat) ==="
